...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        if (!selectedValuesAreDefault) {
            paint.setTextSize(mTextSize);
            paint.setTypeface(Font.fontPhilo_Regular(getContext()));
...
//            String maxText = String.valueOf(getSelectedMaxValue());
            String minText = "Rp. " + String.valueOf(getSelectedMinValue()) + " Jt";
            String maxText = "Rp. " + String.valueOf(getSelectedMaxValue()) + " Jt";
            
            if( String.valueOf(getSelectedMaxValue()).equals("6000")){
            	maxText = "> Rp. 6M";  
            }
