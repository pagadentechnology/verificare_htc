...
//			cLatitude = "-6.3025544";
		...
		protected void onPostExecute(Void result) {
			...
			if (row_count.equals("1")) {				
				DialogLocationConfirmation dialog = new DialogLocationConfirmation(getApplicationContext(), "Input Success", 9);
...
//				finish();
				...
				DialogLocationConfirmation dialog = new DialogLocationConfirmation(getApplicationContext(), "Somethine wrong please contact administator", 9);
				dialog.setCancelable(false);
				dialog.show(getSupportFragmentManager(), "");
